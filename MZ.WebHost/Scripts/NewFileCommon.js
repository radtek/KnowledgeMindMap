    ...
    setTimeout(function () {
        if ($.connection.hub.state == 4) {
            ...
            $.connection.hub.start({ jsonp: true }).done(function () {
                ...
                if ($("#mttInfo").length == 0) {
                    $(document.body).append('<div class="yh-Mtt" id="mttInfo"><div class="yh-Mtt-tit"><div class="yh-Mtt-tit-name">MTT飞象</div><div class="yh-Mtt-tit-close" onclick="$(\'#mttInfo\').remove();"><i class="yh-Mtt-tit-close-img"></i></div></div><div class="yh-Mtt-con"><a href="/webMT/app/newInstall/MTTSetup.exe" class="yh-Mtt-btn_start">下载客户端</a><span class="yh-Mtt-link">提示：本机未安装MTT飞象，请先下载后安装！</span></div></div>');
                    SetInfoPosition();
                }
            });
...
//        if (o.RootDir != "" && rootDirList.indexOf(o.RootDir) == -1) {
//            var rootDir = o.RootDir;
//            var nativePath = o.NativePath;
//            var curPath = nativePath.substring(rootDir.length);
//            curPath = curPath.split("\\")[0];
//            addAttachment(curPath);
//            rootDirList[rootDirList.length] = rootDir;
//        } else if (o.RootDir == "") {
...
function addAttachment(curName) {
    var html = "";
    html += curName +"   ";
