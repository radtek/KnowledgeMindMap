                    ...
                    if (len > 0) {
                        for (var i = 0; i < len; i++) {
                            ...
                            if (indType != "5") {
                                ...
                                $("#p-j-r" + type + "-item" + itemId + "-Ind" + lineListInfo[i].metaObjId).html(html);
//                                $("#p-j-r" + type + "-item" + itemId + "-Ind" + lineListInfo[i].metaObjId).load("/Contrast/ImageRollAxcx?itemId=" + itemId + "&col=" + type + "&resultId=" + resultId + "&indId=" + lineListInfo[i].metaObjId + "&resultType=2&r=" + Math.random(), function () {
//                                    myFocus.set({
//                                        id: 'myFocus_' + type + '_' + lineListInfo[i].metaObjId,
//                                        pattern: 'mF_YSlider',
//                                        height: 270,
//                                        width: 200
//                                    });
    ...
    $.post("/Home/GetSelectObjList",
         {
             ...
             if (data.Success == true) {
                 ...
                 $("#p-j-contrastLine" + type + "-" + itemId).append('<option value="0">--选择产品线--</option>');
