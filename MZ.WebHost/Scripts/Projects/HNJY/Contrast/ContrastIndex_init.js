...
$('#p-j-contrast').on('mouseenter', '.p-j-showLargePic', function () {
    ...
    $('body').append('<div id="p-j-showLargePic-pic" style="top:'
                + t + 'px;left:' + l + 'px;z-index: 100; position: absolute; box-shadow: 3px 3px 3px rgba(0,0,0,0.2); background:#fff; border:1px solid #ddd; padding:5px;"><img src="'
                + $this.attr('src').replace('_hs.', '_ul.') + '"></div>');
