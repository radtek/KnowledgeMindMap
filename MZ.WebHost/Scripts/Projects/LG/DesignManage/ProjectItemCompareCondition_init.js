...
function choseProj(kind, updateDate1, updateDate2, cityId) {
    ...
    if (kind == 1 || kind == 3) {
        $(".p-j-selProjDiv").load("/Contrast/ChoseItemConProject?formatId=" + formatId + "&updateDate1=" + updateDate1 + "&updateDate2=" + updateDate2 + "&cityId=" + cityId + "&isOutside=" + isOutside + "&r=" + Math.random());
        highLightProj();
    }
    if (kind == 2 || kind == 3) {
        $(".p-j-selProj2Div").load("/Contrast/ChoseProjConProject?formatId=" + formatId + "&updateDate1=" + updateDate1 + "&updateDate2=" + updateDate2 + "&cityId=" + cityId + "&isOutside=" + isOutside + "&r=" + Math.random());
    }
}
