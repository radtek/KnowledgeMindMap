...
//                    $firstTd.attr('rowspan', $firstTd.attr('rowspan') * 1 + count)
        ...
        //SetMenu(2, 1);
        var firstMenuItem = 2, secondMenuItem = 1;
        if (isOutside == '1') firstMenuItem = 4;
        if (isEdit == '1') secondMenuItem = 2;
        SetMenu(firstMenuItem, secondMenuItem);
                            ...
                            $("td[class=p-j-r" + type + "-" + lineListInfo[i].treeItemId + "]").each(function () {
                                ...
                                if (lineListInfo[i][curdataKey] != null) {
                                    ...
                                    if (indType != 5) {
                                        ...
                                        console.log(lineListInfo[i][curdataKey]);
                                        $(this).html(html);
                                    } else {
                                        var html = $.map(lineListInfo[i][curdataKey].split(/[\r\n]+/), function (v) {
                                            if (v) {
