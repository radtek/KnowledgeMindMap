...
a2DataGrid.prototype.addDocType = function () { // 添加资料类别设置
    ...
    box(commApi.docSettingUrl + "?taskId=" + tid + "&projId=" + self.projId + "&r=" + Math.random(), { boxid: 'docType', title: '资料专业阶段设置', cls: 'shadow-container', contentType: 'ajax', modal: true, no_cancel: true, width: 800, submit_BtnName: "取消",
        onLoad: function (o) {
