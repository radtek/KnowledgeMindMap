...
var bindASearchableInput = function (o, userIdObj, profIdObj, projectId, type, hasProfSelect, needsearch) {
    ...
    $(o).unbind("keyup").bind("keyup", function (e) {
        addKeyboardControlSupport(o, userIdObj, profIdObj, projectId, type, hasProfSelect,e);
    });
...
function addKeyboardControlSupport(o, userIdObj, profIdObj, projectId, type, hasProfSelect, e) {
