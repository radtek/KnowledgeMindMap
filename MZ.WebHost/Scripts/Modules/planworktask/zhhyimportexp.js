...
var a3plan_impexp = (function () {
    ...
    function __importExp(force, projID, fromPlan) { // 导入经验
        ...
        box(url, { boxid: 'loadExp', title: '载入公司经验', contentType: 'ajax', modal: true, submit_BtnName: '确定导入', cls: 'shadow-container', width: 450,
            onLoad: function (o) {
                //o.fbox.center();
                ...
                //$("#secPlanName").val(projName || ""); 在页面上设置初始值
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.Success) {
                                    ...
                                    //                                    var gourl = '/DesignManage/MultiPlanManage?projId=';
