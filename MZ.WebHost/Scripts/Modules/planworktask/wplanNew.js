...
var a3plan = (function () {
    ...
    return {
        createPlan: function (t, pos, force, isJD) {
            ...
            $.YH.box({
                target: urls.planInfo + "?projId=" + projId + "&secdPlanId=" + t + "&isContractPlan=" + isTempContractPlan + "&_t=" + new Date().getTime(),
                title: '项目基本信息',
                width: 580,
                modal: true,
                destroy:false,
                afterLoaded: function () {
                    var _o1 = $(this).find("#managerIds"), _o2 = -1, inputfiled = _o1.prev();
