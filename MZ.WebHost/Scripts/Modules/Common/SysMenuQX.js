...
MenuArr[3] = [
    { "name": "项目聚合", "url": "/DesignManage/LandIndex" },
...
MenuArr[7] = [
    { "name": "供应商库", "url": "/Supplier/Designsupplier" },
...
MenuArr[8] = [{ "name": "用户管理", "url": "/HumanResource/UserManage" },
    ...
    { "name": "缺陷类型和部位", "url": "/ProductDevelop/ImproveTypeAndPosition" },
    { "name": "材料采购方式", "url": "/Material/ProcurementMethodManage" },
    { "name": "首页管理", "url": "/PersonelWorkCenter/HomeIndexManage" },
    { "name": "市调平台", "url": "http://172.16.62.11:8010/Equipment/HighResidentialDevice" },
    { "name": "编制单位", "url": "/Supplier/EnterpriseManager" },
    { "name": "系统日志", "url": "/LogReport/QXLogIndex" }
    ];
