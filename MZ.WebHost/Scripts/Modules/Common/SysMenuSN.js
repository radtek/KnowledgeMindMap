...
MenuArr[0] = [{ "name": "首页,", "url": "/DesignManage/NewHome_SN" },
    { "name": "产品定位管理", "url": "/DesignManage/ProductPositioning" },
    { "name": "项目设计管理", "url": "/DesignManage/EngManage" },
    { "name": "产品资源管理", "url": "/Material/MaterialStorage" },
    { "name": "设计供应商管理", "url": "/Supplier/Designsupplier" },
    { "name": "产品库", "url": "/StandardResult/StandardLibraryIndex" },
    { "name": "系统设置,", "url": "/HumanResource/UserManage"}];

MenuArr[2] = [{ "name": "产品决策定位", "url": "/DesignManage/ProductPositioning" },
    { "name": "项目周边竞品楼盘指标", "url": "/ProjectPeriphery/ProjectPeripherySummary"}];
...
MenuArr[4] = [{ "name": "部品材料库", "url": "/Material/MaterialStorage" },
    ...
    { "name": "工艺工法库", "url": "/StandardResult/StandardResultLibrary?libId=6"}];
...
MenuArr[6] = [{ "name": "标准化设置", "url": "" },
    ...
    { "name": "单体库", "url": "/StandardResult/StandardResultLibrary?libId=5"}];
