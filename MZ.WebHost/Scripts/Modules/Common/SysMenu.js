...
MenuArr[2] = [{ "name": "产品标准平台", "url": "/ProductDevelop/ProductSeriesIndex" },
    ...
    { "name": "价值树设置", "url": "/ProductDevelop/ValueTreeManage" }
    ];
...
MenuArr[7] = [
    { "name": "标准管理文件库", "url": "/DevDatabase/StandardManagementLibrary" },
    { "name": "离散设计要素库", "url": "/DevDatabase/DiscreteDesignLibrary" },
    { "name": "标杆案例库", "url": "/DevDatabase/CaseModelsIndex" },
    { "name": "设计成果资料归档", "url": "/DevDatabase/OldProjDocLibrary" }
    ];
...
MenuArr[8] = [
    { "name": "土地库首页", "url": "/ProductDevelop/LandCountryIndex" },
    { "name": "土地库管理", "url": "/ProductDevelop/LandLibraryManage" }
    ];

MenuArr[9] = [
    { "name": "客群库首页", "url": "/ProductDevelop/SegmentLibraryIndex" },
