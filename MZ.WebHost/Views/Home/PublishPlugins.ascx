...
<table border="1">
    ...
    <tr>
        ...
        <td>
            <input type="button" code="WPM" onclick="publishClient(this);" value="发布到HOST" />
        </td>
    </tr>
     <tr>
        <td>
        ...
        <td>
            <input type="button" code="LifeDayGame" onclick="publishClient(this);" value="发布到HOST" />
        </td>
    </tr>
</table>
<%  } %>
